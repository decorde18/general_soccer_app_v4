...
start our player stats. we need Games started, played, shots, saves,goals, assists, YC, RC, minutes, plus/minus, clean sheets for GKs, game winning goals. We need season/career. 
We need team stats (vs opponents, gf, ga). 
clean up temp and test files. remove everything not needed
