...
export default async function AdminDashboardPage() {
  const adminModules = [
    {
      title: "User Accounts",
      description: "Manage login credentials, profiles, passwords, and system administrator access levels.",
      route: "/admin/users",
      icon: Users,
    ...
    },
    {
      ...
      description: "Assign club administrators, directors, head/assistant coaches, team managers, and stats keepers.",
      route: "/admin/clubs",
      icon: Shield,
    ...
    },
    {
      ...
      description: "Create, edit, and configure seasons, start/end dates, and lifecycle statuses (upcoming, active, etc.).",
      route: "/admin/seasons",
      icon: Calendar,
    ...
    },
    {
      ...
      description: "Configure the organizational hierarchy, divisions, conferences, and tournament brackets.",
      route: "/admin/leagues",
      icon: Activity,
    ...
    },
    {
      ...
      description: "Manage soccer associations, regional leagues, and governing organizations profiles.",
      route: "/governing-bodies",
      icon: Trophy,
      color: "from-yellow-500/10 to-amber-500/10 border-yellow-500/20 text-yellow-500",
    },
    {
      title: "Locations & Fields",
      description: "Configure stadium names, locations, and sublocation game fields or turf surfaces.",
      route: "/locations",
      icon: MapPin,
    ...
    },
    {
      ...
      description: "Manage mail address profiles linked to clubs and soccer facilities.",
      route: "/addresses",
      icon: Map,
    ...
    <div className="p-6 max-w-6xl mx-auto space-y-8">
      ...
      <div className="relative overflow-hidden rounded-2xl border border-border bg-surface/50 p-8 shadow-sm backdrop-blur-sm">
        ...
        <div className="relative z-10 space-y-2">
          ...
          <p className="text-muted text-sm max-w-2xl">
            Welcome to the soccer app administration center. Choose an administrative module below to configure global settings, manage security roles, or configure league parameters.
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {adminModules.map((module) => {
          ...
          return (
            <Link href={module.route} key={module.route} className="block group h-full">
              <Card
                variant="hover"
                padding="lg"
              ...
              >
                <div className="space-y-4">
                  {/* Icon Box */}
                  <div className={`h-12 w-12 rounded-xl border flex items-center justify-center bg-gradient-to-br ${module.color}`}>
                    <Icon size={22} />
                  </div>
