        ...
        <div className="space-y-4 py-2">
          ...
          {!isOpponentGoal && (
            <>
              <Select
                ...
                value={goalScorerId}
                onChange={(val: any) => setGoalScorerId(typeof val === "string" ? val : val?.target?.value ?? "")}
              />
              <Select
                label="Assisted By"
                options={[{ value: "", label: "-- None / Select Assist --" }, ...playerOptions]}
                value={goalAssistId}
                onChange={(val: any) => setGoalAssistId(typeof val === "string" ? val : val?.target?.value ?? "")}
              />
            </>
          )}
          ...
          <div className="grid grid-cols-3 gap-3">
            <Select
              ...
              value={goalType}
              onChange={(val: any) => setGoalType(typeof val === "string" ? val : val?.target?.value ?? "")}
            />
            <Select
              label="Match Period"
              options={periodOptions}
              value={goalPeriod}
              onChange={(val: any) => setGoalPeriod(typeof val === "string" ? val : val?.target?.value ?? "")}
            />
      ...
      >
        <div className="space-y-4 py-2">
          <Select
            ...
            value={subInId}
            onChange={(val: any) => setSubInId(typeof val === "string" ? val : val?.target?.value ?? "")}
          />
          <Select
            label="Player OUT"
            options={[{ value: "", label: "-- Select Player Out --" }, ...playerOptions]}
            value={subOutId}
            onChange={(val: any) => setSubOutId(typeof val === "string" ? val : val?.target?.value ?? "")}
          />
          ...
          <div className="grid grid-cols-3 gap-3">
            <Select
              ...
              options={periodOptions}
              value={subPeriod}
              onChange={(val: any) => setSubPeriod(typeof val === "string" ? val : val?.target?.value ?? "")}
            />
            <Input
              label="Minute (mm)"
              type="number"
      ...
      >
        <div className="space-y-4 py-2">
          <Select
            ...
            value={cardPlayerId}
            onChange={(val: any) => setCardPlayerId(typeof val === "string" ? val : val?.target?.value ?? "")}
          />
          ...
          <div className="grid grid-cols-3 gap-3">
            <Select
              ...
              value={cardType}
              onChange={(val: any) => setCardType(typeof val === "string" ? val : val?.target?.value ?? "")}
            />
            <Select
              label="Match Period"
              options={periodOptions}
              value={cardPeriod}
              onChange={(val: any) => setCardPeriod(typeof val === "string" ? val : val?.target?.value ?? "")}
            />
            <div className="grid grid-cols-2 gap-2">
              <Input
                label="Min (mm)"
