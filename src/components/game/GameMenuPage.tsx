...
//               className="mb-2 flex items-center gap-1 text-sm font-medium text-slate-500 transition-colors hover:text-slate-800"
//             >
//               <ChevronRight className="h-4 w-4 rotate-180" /> Back to Games
//             </button>
...
//             <div className={`h-3 w-3 animate-pulse rounded-full ${stageInfo.statusColor}`} />
...
//                   Make sure your lineup is set before starting the game. You can always
//                   adjust settings or fix clock issues in the &quot;Game Management&quot;
//                   section.
//                 </p>
//               </div>
//             </div>
        ...
        <div className='grid grid-cols-1 gap-6 lg:grid-cols-3'>
          ...
          <div className='lg:col-span-2'>
            ...
            <div className='grid grid-cols-2 gap-4'>
              ...
              //TODO: GameActionCard Placeholder
            </div>
            // {/* Additional Help / Context */}
            <div className='mt-8 flex gap-4 rounded-xl border border-blue-100 bg-blue-50/50 p-4'>
              //{" "}
